...
const INTERACTIVE_SCENES = [pinballPocket, appInterface, marbleMaze, marbleMazeRaised, tactileRadio, tactileFocus, tactileLights, hideAndSeekDollhouse,
  thumbwheelBank, trackballConsole, recessedMixer, rockerPanel, shuttleDial, springJoystick];

const ALL = [pinballPocket, light, relief, portal, terrain, pocket, crystal, tunnel, garden, orbit, phoneUi, appInterface, jellyfish,
