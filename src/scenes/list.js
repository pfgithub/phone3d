...
const INTERACTIVE_SCENES = [whackAMole, waterLevel, sandTimerTray, pinballPocket, appInterface, marbleMaze, marbleMazeRaised, tactileRadio, tactileFocus, tactileLights, hideAndSeekDollhouse,
  thumbwheelBank, trackballConsole, recessedMixer, rockerPanel, shuttleDial, springJoystick];

const ALL = [whackAMole, waterLevel, sandTimerTray, pinballPocket, light, relief, portal, terrain, pocket, crystal, tunnel, garden, orbit, phoneUi, appInterface, jellyfish,
